...
class Checkout: UIViewController ,CLLocationManagerDelegate ,MKMapViewDelegate {
    ...
    @IBAction func submit(_ sender: UIButton) {
            ...
            
        {
            ...
            self.ref.child(trainername.text!).child("Check Out").setValue(["trainername" : trainername.text,"showdatetime" : showdatetime.text,"Latitude" : Long,"Longitude" : Lat] )
        ...
        else
        {
            ...
            performSegue(withIdentifier: "custom2", sender:self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        destination.trainernamesss = trainername.text!
        destination.showdatetimesss = showdatetime.text!
